...
e
   ...
   /**
    * Return the difference of <code>p2</code> from <code>p1</code>
    * where the return type is of <code>PolyDefault</code>.
    * 
    * @param p1 The polygon to subtract from.
    * @param p2 The polygon to subtract.
    */
   ...
   public static Poly diff(Poly p1, Poly p2, Class class1) {
		return clip(OperationType.GPC_DIFF,p1,p2,class1);
	}
