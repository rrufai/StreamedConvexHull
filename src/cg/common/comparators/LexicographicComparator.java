...
public class LexicographicComparator<K extends Point> implements GeometricComparator<K> {
    ...
    protected Direction order = Direction.BOTTOM_UP;
    ...
    /**
     * Comparison function to be used to sort from Bottom to Top. So,
     * p1 is greater if it  lies below p2.
     * @param p1
     * @param p2
     * @return 
     */
...
/**
     * Comparison function to compare left to right. So, a point p1 is GREATER THAN point 
     * p2 if p1 lies to the LEFT of p2.
     * @param p1
     * @param p2
     * @return 
     */
