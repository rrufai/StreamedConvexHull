 ...
 * @author rrufai
 */
public class BigNumberTools {

    public static BigDecimal sqrt(BigDecimal number){
        return sqrt(number, MathContext.DECIMAL128);
        //return Utilities.BigNumberTools.sqrt(number);
    }

    /**
     * @author Frans Lelieveld, NovaLoka.nl
    ...
    public static BigDecimal sqrt(BigDecimal squarD, MathContext rootMC) {
        ...
        double SQRT_10 = 3.1622776601683795;
        ...
        BigDecimal x = null;
        BigDecimal e = null; // initial x:  x0 ~ sqrt()
        BigDecimal v = null;
        BigDecimal g = null; // initial v:  v0 = 1/(2*x)
        ...
        scale = (int) Math.floor(scale / 2.0); // ..where 100 -> 10 shifts the scale
        ...
        for (int i = nPrecs.size() - 1; i > -1; i--) {
            ...
            RoundingMode mode = ((i % 2 == 1)? RoundingMode.HALF_UP : RoundingMode.HALF_DOWN);
            nMC = new MathContext(nPrecs.get(i), mode);
            // Next x                                                 // e = d - x^2
