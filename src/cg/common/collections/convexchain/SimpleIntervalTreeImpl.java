...
class SimpleIntervalTreeImpl<K extends Point> implements IntervalTree<K> {
    ...
    public List<K> extractHull() {
        ...
        delete(rootLayer);
        Logger.getGlobal().log(Level.INFO, END);
    ...
    public void delete(ConvexChain<K> chain) {
        Logger.getGlobal().log(Level.INFO, "entering delete");
        Logger.getGlobal().log(Level.INFO, "chain: \n{0}", chain);

        if (!isNull(chain) && !isNull(hullChain) && hullChain.containsAll(chain)) {
            Logger.getGlobal().log(Level.INFO, "this before: \n{0}", this);
            ...
            if (!isNull(left) || !isNull(right)) {
                ...
                Logger.getGlobal().log(Level.INFO, "al = {0}, ar = {1} \n", new Object[]{al, ar});
                switch (getCase(al, ar, extremes)) {
                    case 1:
                        ...
                        //do nothing
                        Logger.getGlobal().log(Level.INFO, "Case I: Nothing to do -- Both Roof leftovers are above the bridge");
                        break;
                    ...
                    case 2:
                        ...
                        Logger.getGlobal().log(Level.INFO, "Case II: Only Left Roof leftover (.. al) is above bridge");
...
//                    rightToLeftCursor = newCursors.getValue();
                    ...
                    case 3:
                        ...
                        Logger.getGlobal().log(Level.INFO, "Case III: Only Right Roof leftover (ar ...) is above bridge");
...
//                    rightToLeftCursor = newBC.getValue();
                    ...
                    case 4:
                        ...
                        Logger.getGlobal().log(Level.INFO, "Case IV: Both roof leftovers are below the bridge.");
...
//                    rightToLeftCursor = newBC.getValue();
            ...
            Logger.getGlobal().log(Level.INFO, "this after: \n{0}", this);
        }
        ...
        Logger.getGlobal().log(Level.INFO, "exiting delete");
    }

    @Override
    public boolean insert(ConvexChain<K> chain) {
        Logger.getGlobal().log(Level.INFO, "entering insert:");
        Logger.getGlobal().log(Level.INFO, "input: chain = {0}", chain);

        ConvexChain<K> extractedPoints = hullChain.insert(chain);

        Logger.getGlobal().log(Level.INFO, "ExtractedPoints to be pushed down: {0}", extractedPoints);
        ...
        Logger.getGlobal().log(Level.INFO, "Result after pushdown: \n{0}", this);
        Logger.getGlobal().log(Level.INFO, "Exiting insert.");
